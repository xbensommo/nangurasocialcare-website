    ...
    <div class="w-full max-w-2xl bg-[var(--color-neutral-dark)]/40 backdrop-blur-3xl border border-white/5 p-10 rounded-none shadow-2xl relative">
      ...
      <header class="mb-10">
        <h1 class="text-3xl font-display font-bold text-white tracking-tighter italic uppercase">
          Modify <span class="text-[var(--color-primary)]">Notes</span>
        </h1>
      ...
      <form v-else @submit.prevent="handleSubmit" class="space-y-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
          ...
          <div class="group flex flex-col">
            ...
            <div class="relative">
              <input 
                v-model="form.notedId" 
                type="text" 
                class="w-full bg-white/[0.03] border border-white/10 rounded-none px-5 py-4 text-sm text-white focus:outline-none focus:border-[var(--color-primary)] focus:bg-white/[0.07] transition-all placeholder:text-white/5"
                placeholder="Enter notedId..."
              />
              <i v-if="errors.notedId" class="fa fa-circle-exclamation absolute right-4 top-1/2 -translate-y-1/2 text-red-500 text-xs"></i>
            </div>

            <p v-if="errors.notedId" class="text-red-500 text-[9px] mt-2 font-bold uppercase tracking-tighter">
              {{ errors.notedId }}
            </p>
          </div>
          ...
          <div class="group flex flex-col">
            ...
            <div class="relative">
              ...
              />
              <i v-if="errors.content" class="fa fa-circle-exclamation absolute right-4 top-1/2 -translate-y-1/2 text-red-500 text-xs"></i>
            </div>

            <p v-if="errors.content" class="text-red-500 text-[9px] mt-2 font-bold uppercase tracking-tighter">
              {{ errors.content }}
            </p>
          </div>
          ...
          <div class="group flex flex-col">
            ...
            <div class="relative">
              ...
              />
              <i v-if="errors.iv" class="fa fa-circle-exclamation absolute right-4 top-1/2 -translate-y-1/2 text-red-500 text-xs"></i>
            </div>

            <p v-if="errors.iv" class="text-red-500 text-[9px] mt-2 font-bold uppercase tracking-tighter">
              {{ errors.iv }}
            </p>
          </div>
          ...
          <div class="group flex flex-col">
            ...
            <div class="relative">
              ...
              />
              <i v-if="errors.version" class="fa fa-circle-exclamation absolute right-4 top-1/2 -translate-y-1/2 text-red-500 text-xs"></i>
            </div>

            <p v-if="errors.version" class="text-red-500 text-[9px] mt-2 font-bold uppercase tracking-tighter">
              {{ errors.version }}
            </p>
          </div>
...
const schema = z.object({
    ...
    notedId: z.string()
      .min(1, { message: "notedId is required" })
      ,
