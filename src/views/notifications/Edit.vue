  ...
  <div class="min-h-screen bg-[var(--color-background)] flex flex-col items-center justify-center p-6 font-[var(--fontfamily-sans)]">
    ...
    <div class="w-full max-w-2xl mb-6">
      <button @click="router.back()" class="group text-[var(--color-neutral)] hover:text-white transition-all flex items-center gap-2 text-[10px] font-bold uppercase tracking-[0.2em]">
        ...
        Return to Notifications Registry
      </button>
    </div>
    ...
    <div class="w-full max-w-2xl bg-[var(--color-neutral-dark)]/40 backdrop-blur-3xl border border-white/5 p-10 rounded-none shadow-2xl relative">
      ...
      <header class="mb-10">
        <h1 class="text-3xl font-display font-bold text-white tracking-tighter italic uppercase">
          Modify <span class="text-[var(--color-primary)]">Notifications</span>
        </h1>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
          ...
          <div class="group flex flex-col">
            ...
            <div class="relative">
              ...
              />
              <i v-if="errors.userId" class="fa fa-circle-exclamation absolute right-4 top-1/2 -translate-y-1/2 text-red-500 text-xs"></i>
            </div>

            <p v-if="errors.userId" class="text-red-500 text-[9px] mt-2 font-bold uppercase tracking-tighter">
              {{ errors.userId }}
            </p>
          </div>
          ...
          <div class="group flex flex-col">
            ...
            <div class="relative">
              <input 
                ...
                type="text" 
                class="w-full bg-white/[0.03] border border-white/10 rounded-none px-5 py-4 text-sm text-white focus:outline-none focus:border-[var(--color-primary)] focus:bg-white/[0.07] transition-all placeholder:text-white/5"
                placeholder="Enter isRead..."
              />
              <i v-if="errors.isRead" class="fa fa-circle-exclamation absolute right-4 top-1/2 -translate-y-1/2 text-red-500 text-xs"></i>
            </div>

            <p v-if="errors.isRead" class="text-red-500 text-[9px] mt-2 font-bold uppercase tracking-tighter">
              {{ errors.isRead }}
            </p>
          </div>
          ...
          <div class="group flex flex-col">
            ...
            <div class="relative">
              ...
              />
              <i v-if="errors.type" class="fa fa-circle-exclamation absolute right-4 top-1/2 -translate-y-1/2 text-red-500 text-xs"></i>
            </div>

            <p v-if="errors.type" class="text-red-500 text-[9px] mt-2 font-bold uppercase tracking-tighter">
              {{ errors.type }}
            </p>
          </div>
          ...
          <div class="group flex flex-col">
            ...
            <div class="relative">
              ...
              />
              <i v-if="errors.referenceId" class="fa fa-circle-exclamation absolute right-4 top-1/2 -translate-y-1/2 text-red-500 text-xs"></i>
            </div>

            <p v-if="errors.referenceId" class="text-red-500 text-[9px] mt-2 font-bold uppercase tracking-tighter">
              {{ errors.referenceId }}
            </p>
          </div>
          ...
          <div class="group flex flex-col">
            ...
            <div class="relative">
              ...
              />
              <i v-if="errors.createdAt" class="fa fa-circle-exclamation absolute right-4 top-1/2 -translate-y-1/2 text-red-500 text-xs"></i>
            </div>

            <p v-if="errors.createdAt" class="text-red-500 text-[9px] mt-2 font-bold uppercase tracking-tighter">
              {{ errors.createdAt }}
            </p>
          </div>
